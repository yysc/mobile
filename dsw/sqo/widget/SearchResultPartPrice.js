define([
    ...
    return	declare("dsw.sqo.widget.SearchResultPartPrice", [WidgetBase], {
		...
		buildRendering: function(){
            ...
            if(this.quoteType != "SaaS"){
                 widgetContent += "<ul data-dojo-type=\"dojox/mobile/EdgeToEdgeList\" class=\"softwarePartList\" id=\"searchResultSoftwarePartList\">";
                 for(var i=0; i< this.softwareQuoteLineItems.length; i++){
                    ...
                    widgetContent += "<span class=\"partDiscountValue\">"+ softwareQuoteLineItem.lineDiscPct + "</span></li>";
            ...
            if(this.quoteType != "Software"){
                 widgetContent += "<ul data-dojo-type=\"dojox/mobile/EdgeToEdgeList\" class=\"saasPartList\" id=\"searchResultSaaSPartList\">";
                 for(var i=0; i< this.saasQuoteLineItems.length; i++){
                    ...
                    for(var j=0; j<saasQuoteLineItem.configurations.length; j++){
                        ...
                        widgetContent += "<span class=\"saasPartLevelTwoIcon\">&nbsp;</span></li>";
                        for(var k=0; k<configuration.partList.length; k++){
                            ...
                            widgetContent += "<span class=\"saasPartLevelThreeIcon\">" + part.lineDiscPct + "</span></li>";
